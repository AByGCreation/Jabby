   ...
   Begin DesktopRectangle Rectangle1
      ...
      Begin GroupBox groupAppConfig
         ...
         Begin DesktopLabel SelectedFolderItemLabel2
            ...
            Width           =   135
         End
         Begin DesktopCheckBox cbHeader
            AllowAutoDeactivate=   True
            Bold            =   False
...
#tag WindowCode
	...
	#tag Event
		Sub Opening()
		  lbVersionSoft.Text = Me.Title+ " - v."+App.MajorVersion.ToString +"."+ App.MinorVersion.ToString+"."+ App.BugVersion.ToString+"."+ App.NonReleaseVersion.ToString 
		  guiUpdater()
		  lbProgressBar.Text=""
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h0
		Sub CSVparser(csv as String)
		  ...
		  Select Case UIThread.ThreadState 
	...
	#tag Method, Flags = &h0
		Sub guiUpdater()
		  ...
		  lbNbElement.Text = ListBox1.RowCount.ToText +" element(s) founded."
		  
		  headerPresent = cbHeader.Value
		End Sub
	#tag EndMethod
		...
		Sub ICSgenerator()
		  ...
		  For Each vevent As DesktopListBoxRow In ListBox1.rows
		    ...
		    If vevent.CellTextAt(1) <> "" Then
		      ...
		      For col =0 To vevent.ColumnCount-1
	...
	#tag Method, Flags = &h0
		Sub test()
		  If threadError=False Then
		    ...
		    d.Message = "An error occured when parsing header"
...
#tag Events btChooseCSVFile
	#tag Event
		Sub Pressed()
		  ...
		  dialog.Filter = FileTypes1.CSV
		  
		  // The OpenDialog class supports custom prompts
		  dialog.PromptText = "Please select a valid CSV file"
		  
		  // and custom titles
		  dialog.Title = "Choose your CSV file"
...
#tag Events btClearList
	#tag Event
		Sub Pressed()
		  ...
		  If UIThread.ThreadState = Thread.ThreadStates.NotRunning Then
		    If clearList() Then
		    End If
...
#tag Events UIThread
	#tag Event
		Sub Run()
		  ...
		  For Each veventLine As String In stLine
		    stCol = veventLine.Split( sepChar) 
		    col=0
		...
		Sub UserInterfaceUpdate(data() as Dictionary)
		  For Each arg As Dictionary In data
		    If arg.HasKey("UIProgress") Then
		      ...
		      If arg.Value("UIProgress").IntegerValue = 100 Then
		    ...
		    If( arg.HasKey("headColNum") And arg.HasKey("colVal")) Then
		      ...
		      If arg.Value("headColNum").IntegerValue <= 255 Then
